...
<template>
    <div class="relative">
        <nuxt-img src="/pens.jpg" format="webp" alt="chalkboard" class="w-full h-72 md:h-96 object-cover" />
    ...
    <div class="grid md:grid-cols-2 mx-auto">
        <div class="flex flex-col space-y-8 items-center">
            ...
            <div class="grid md:grid-cols-2 mx-12 md:mx-24 gap-8">
                <nuxt-img src="/room.jpg" format="webp" alt="room" />
                <nuxt-img src="/room.jpg" format="webp" alt="room" />
            </div>
    ...
    <div class="relative">
        <nuxt-img src="/pens.jpg" format="webp" alt="chalkboard" class="w-full h-96 object-cover" />
        <div
            ...
            <p class="text-lg md:text-xl">Deshalb muss auch jeder seinen Weg finden und ​jeder soll die auf ihn persönlich
